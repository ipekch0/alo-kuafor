                ...
                {[
                    ...
                    return (
                        <button
                            ...
                            className={`flex items-center gap-2 px-3 sm:px-4 py-2 rounded-xl font-medium transition-all text-xs sm:text-sm ${isActive
                        ...
                        >
                            ...
                            <span className={`hidden xs:inline-block px-1.5 sm:px-2 py-0.5 rounded-full text-[10px] sm:text-xs ${isActive ? 'bg-white/20' : 'bg-slate-100 text-slate-600'
                                }`}>
