...
const Hero = () => {
    ...
    return (
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
            ...
            <div className="absolute bottom-0 right-0 w-[800px] h-[600px] bg-purple-200/20 rounded-full blur-3xl -z-10" />
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="flex flex-col items-center text-center max-w-5xl mx-auto">
                    ...
                    >
                        ...
                        <div className="bg-white p-2 rounded-[2.5rem] shadow-2xl shadow-indigo-900/5 border border-slate-100 max-w-5xl mx-auto relative">
                            ...
                            <div className="flex flex-col md:flex-row items-center p-2 gap-2">
                                ...
                                <div className="flex-1 w-full flex items-center gap-2">
                                    <div className="relative group flex-1">
                                        <div className="absolute left-4 top-1/2 -translate-y-1/2 w-8 h-8 bg-indigo-50 rounded-full flex items-center justify-center text-indigo-500">
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-slate-50 hover:bg-slate-100 focus:bg-white rounded-[2rem] pl-14 pr-4 py-5 outline-none text-slate-900 font-bold text-base cursor-pointer appearance-none border border-transparent focus:border-indigo-100"
                                        >
                                    ...
                                    <div className="relative group flex-1">
                                        <select
                                            ...
                                            className="w-full bg-slate-50 hover:bg-slate-100 focus:bg-white rounded-[2rem] px-4 py-5 outline-none text-slate-900 font-bold text-base cursor-pointer appearance-none border border-transparent focus:border-indigo-100 disabled:opacity-50 disabled:cursor-not-allowed"
                                        >
                                            <option value="">İlçe Seçiniz</option>
                                            {selectedCity && cities.find(c => c.name === selectedCity)?.districts.map(dist => (
                                ...
                                <button
                                    ...
                                    className="w-full md:w-auto bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-5 rounded-[2rem] hover:scale-[1.02] active:scale-95 transition-all duration-300 shadow-xl shadow-indigo-600/20 flex items-center justify-center gap-3 min-w-[140px]"
                                >
                        ...
                        <div className="mt-10 flex flex-wrap items-center justify-center gap-3 text-sm text-slate-500">
                            ...
                            <Link to="/search?q=gelin-basi" className="px-4 py-1.5 bg-white border border-slate-200 rounded-full hover:border-indigo-300 hover:text-indigo-600 hover:shadow-sm transition-all text-slate-500">Gelin Başı</Link>
                            <Link to="/search?q=protez-tirnak" className="px-4 py-1.5 bg-white border border-slate-200 rounded-full hover:border-indigo-300 hover:text-indigo-600 hover:shadow-sm transition-all text-slate-500">Protez Tırnak</Link>
                            <Link to="/search?q=cilt-bakimi" className="px-4 py-1.5 bg-white border border-slate-200 rounded-full hover:border-indigo-300 hover:text-indigo-600 hover:shadow-sm transition-all text-slate-500">Cilt Bakımı</Link>
                        </div>
