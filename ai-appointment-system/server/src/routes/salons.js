...
router.put('/mine', authenticateToken, async (req, res) => {
    try {
        const { name, description, address, city, district, phone, workingHours } = req.body;
...
router.get('/search', async (req, res) => {
    try {
        ...
        const where = {
            isContracted: true // Only show contracted salons
        };
