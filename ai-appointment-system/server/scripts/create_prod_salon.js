...
async function main() {
    ...
    const salon = await prisma.salon.upsert({
        ...
        update: {
            ...
            whatsappAPIToken: ''
        },
        create: {
            name: 'OdakManage',
